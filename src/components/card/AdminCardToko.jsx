    ...
    return (
        <a className="w-[350px] mx-5 mt-4 block ">
            <div className="w-[350px] shadow-xl rounded-xl">
                ...
                <div className=" px-4">
                    <h3 className="font-bold mx-2 line-clamp-2 text-xl md:mt-3 mt-2 mb-2 text-koreaBlue">{judul}</h3>
                    <p className="m-auto line-clamp-2 text-sm  pb-2 w-[95%]">{deskripsi}</p>
                </div>
