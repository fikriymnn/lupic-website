...
export default function CardNews({gambar,judul,deskripsi,tanggal,id}){
    ...
    return(
        ...
        <a href={"/news/"+id} className="md:w-[400px] md:p-4 w-[90%] md:mx-5 mt-4 ">
        <div className="w-full">
            <Image src={process.env.NEXT_PUBLIC_API_FILE_URL+gambar} alt="foto" width={600} height={300} className="w-[400px] h-[250px] rounded-xl"/>
