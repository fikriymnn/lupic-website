...
export default function PreServiceTestResult() {
    ...
    const getData = async () => {
        try {
            ...
            if (resUser.data) {
                const resNilai = await axios.get(process.env.NEXT_PUBLIC_API_URL + "/api/preservice/nilai/history/" + resUser.data?._id)
                if (resNilai.data) {
