...
import { BookOpen, ChevronRight, Calendar, DollarSign, ArrowLeft, CheckCircle, XCircle, FileText } from 'lucide-react';
...
const ModulAjarAccessList = () => {
        ...
        try {
            ...
            if (userData) {
                ...
                const res = await fetch(
                    process.env.NEXT_PUBLIC_API_URL + "/api/modul_ajar_access?userId=" + userData._id
                );
    ...
    const handleRedirectToModul = (modulId) => {
        window.location.href = `/lesson_plans_access/${modulId}`;
    };
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="bg-white rounded-lg shadow-md overflow-hidden">
                            <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-6 text-white">
                                <h1 className="text-2xl font-bold mb-2">Detail Akses Modul Ajar</h1>
                                <p className="opacity-90">{selectedAccess.modulAjarId?.judulModul || 'Judul tidak tersedia'}</p>
                            </div>
                            ...
                            <div className="p-6">
                                ...
                                <div className="mb-6">
                                    <h2 className="text-lg font-bold text-gray-800 mb-4 border-b pb-2">Informasi Modul Ajar</h2>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            <p className="text-sm text-gray-600">Status Modul</p>
                                            <p className="font-semibold text-gray-800">{selectedAccess.modulAjarId?.status || '-'}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                {/* Action Button */}
                                {selectedAccess.status === 'ACCESS' && selectedAccess.modulAjarId?._id && (
                                    <div className="mt-6 pt-6 border-t">
                                        <button
                                            onClick={() => handleRedirectToModul(selectedAccess.modulAjarId._id)}
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-600">
                            Daftar modul ajar yang sudah Anda beli
                        </p>
                    </div>

                    {/* Modul Ajar Access List */}
                    {accessList.length === 0 ? (
                        <div className="bg-white rounded-lg shadow p-12 text-center">
                            ...
                            <p className="text-gray-600">
                                Anda belum membeli modul ajar apapun
                            </p>
                        </div>
                    ) : (
                                    ...
                                    {access.modulAjarId && (
                                        <div className="h-full flex flex-col">
                                            <div className="relative h-48 w-full overflow-hidden">
                                                <img
                                                    src={`${process.env.NEXT_PUBLIC_API_FILE_URL || ''}${access.modulAjarId.cover}`}
                                                    alt={access.modulAjarId.judulModul}
                                            ...
                                            <div className="p-6 flex flex-col flex-1">
                                                <div className="flex flex-wrap gap-2 mb-3">
                                                    <span className="px-3 py-1 bg-blue-100 text-blue-800 text-xs font-semibold rounded-full">
                                                        {access.modulAjarId.jenjang}
                                                    </span>
                                                    <span className="px-3 py-1 bg-gray-100 text-gray-700 text-xs font-semibold rounded-full">
                                                        {access.modulAjarId.topikIPA}
                                                    </span>
                                                </div>

                                                <h3 className="text-xl font-bold text-gray-800 mb-3 line-clamp-2">
                                                    {access.modulAjarId.judulModul}
                                                </h3>
                                                ...
                                                <div className="flex gap-2 mt-auto">
                                                    ...
                                                    {access.status === 'ACCESS' && (
                                                        <button
                                                            onClick={() => handleRedirectToModul(access.modulAjarId._id)}
...
export default ModulAjarAccessList;