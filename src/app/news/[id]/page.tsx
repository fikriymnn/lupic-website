        ...
        <>
            ...
            <div className="w-full m-auto text-center">
                ...
                <div className="md:w-full w-[90%] h-[45%] m-auto flex justify-center">
                    <Image src={process.env.NEXT_PUBLIC_API_FILE_URL+data.gambar} alt="foto" width={600} height={400} className="md:w-[1000px] md:h-[700px] w-full" />
                </div>
                <p className="mt-8 m-auto md:text-xl text-base w-[80%] text-justify">
                    {data.deskripsi}
                </p>
                <p className="mt-6 m-auto md:text-xl text-base w-[80%] text-justify">
                    {parse(data.content)}
                </p>
                {/* looping */}
                {
