        ...
        <div className="m-auto w-full">
          <div className=" m-auto bg-white p-3 rounded-lg shadow-lg w-[80%]">
            <div className="bg-white px-6 pb-6 rounded-xl w-full max-w-3xl m-auto">
              {/* Bagian Atas - Jadwal */}
              <button className="px-3 py-1 border border-black rounded-md text-sm relative right-0">edit</button>
              <br /><br />
              ...
              <div className="border shadow-md rounded-md">
                ...
                <div className="p-5">
                  {['Senin', 'Rabu', 'Jumat'].map((hari, idx) => (
                    <div key={idx} className="border border-black mx-2 my-2 px-4 py-2 rounded">
                      {hari}
                    </div>
                  ))}
                </div>
